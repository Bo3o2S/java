			...
			if(Answer.equals("Y") || Answer.equals("y"))
			{
				...
				if(Answer.equals("1") || Answer.equals("2") || Answer.equals("3"))
				{
					...
					if(Answer.equals("Y") || Answer.equals("y"))
					{
						...
						System.out.println("1년 동안 공부해서  얻을 수 있는 것이 내 인생에 도움이 될까?될거 같으면(Y), 아니면(N)");
						Answer = scan.next();
						scan.nextLine();
						if(Answer.equals("Y") || Answer.equals("y"))
						{
							...
							if(Answer.equals("1") || Answer.equals("2"))
							{
								...
								if(Answer.equals("1"))
								{
									...
									{
										System.out.println("남성역 1번출구 올레kt 매장 건물 4층으로 간다");
										System.out.println("사무실에서 청강을 한다");
										System.out.print("청강을 듣고 학원을 다녀야겠다고 생각했다. 맞으면(Y), 아니면(N) : ");
										Answer = scan.next();
										scan.nextLine();
									...
									{
										System.out.println("서울특별시 동작구 사당동 708-429 2층으로 간다");
										System.out.println("사무실에서 청강을 한다");
										System.out.print("청강을 듣고 학원을 다녀야겠다고 생각했다. 맞으면(Y), 아니면(N) : ");
										Answer = scan.next();
										scan.nextLine();
									...
									{
										System.out.println("서울특별시 동작구 사당동 708-429 4층으로 간다");
										System.out.println("사무실에서 청강을 한다");
										System.out.print("청강을 듣고 학원을 다녀야겠다고 생각했다. 맞으면(Y), 아니면(N) : ");
										Answer = scan.next();
										scan.nextLine();
					...
					{
						System.out.println("연봉을 상승시킬 다른 대안을 찾는다.");
						/*System.out.println("직장을 포기할 것인가?");
